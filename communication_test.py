...
def main():
    ...
    cmdList = [
            [0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0xDF],
    ...
    input("Press Enter to continue...")
    cmdList = []
    cmdList.append(sendValue(554,250,225))
    cmdList.append(sendValue(584,250,225))
    cmdList.append(sendValue(614,250,225))
    cmdList.append(sendValue(644,250,225))
    cmdList.append(sendValue(674,250,225))
    if flagConnected:
        for cmd in cmdList:
            sendCmdWaitForReply(cmd)
            time.sleep(1)
...
LIMITE_SUPERIOR_X = 300
LIMITE_INFERIOR_X = -300
